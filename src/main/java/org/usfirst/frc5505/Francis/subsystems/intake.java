...
public class intake extends Subsystem {
    ...
    public intake() {
        ...
        doubleSolenoid3 = new DoubleSolenoid(0, 0, 1);
        addChild("Double Solenoid 2",doubleSolenoid2);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DEFAULT_COMMAND
        ...
        SmartDashboard.putBoolean("Clamp State", false);
    }
    ...
    public void clamp() {
        ...
        if (doubleSolenoid2.get() != Value.kForward) {
            ...
            SmartDashboard.putBoolean("Clamp State", true);
        }
    }
    ...
    public void intakeJoystick(Joystick stick) {
        if(stick.getRawButton(1) && stick.getRawButton(2) == false) {
            ...
            //stick.setRumble0(RumbleType.kRightRumble, 0);
        }
    } 
