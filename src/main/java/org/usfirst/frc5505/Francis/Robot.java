...
public class Robot extends TimedRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        UsbCamera driverCam = CameraServer.getInstance().startAutomaticCapture("Driver Cam", 0);
        driverCam.setResolution(480, 360);
        UsbCamera visionCam = CameraServer.getInstance().startAutomaticCapture("Vision Cam", 1);
